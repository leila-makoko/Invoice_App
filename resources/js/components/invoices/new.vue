...
const getpoducts = async () => {
    let response = await axios.get("/api/poducts");
    console.log("poducts", response);
    listpoducts.value = response.data.poducts;
};
const SubTotal = () => {
    let total = 0;
...
const onSave=()=>{
    if(listCart,value.lenght>=1){
        ...
        total=Total()
         ...
         formData.append('due_date',form.value.due_.date)
                ...
                <div class="table__footer">
                    <div class="document-footer">
                        ...
                        <textarea
                            ...
                            rows="7"
                            class="textarea"
                            v-model="form.term_and_conditions"
                        ></textarea>
                    </div>
                    <div>
